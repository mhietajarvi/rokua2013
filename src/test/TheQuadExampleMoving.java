...
public class TheQuadExampleMoving {
	...
	public TheQuadExampleMoving() {
		...
		while (!Display.isCloseRequested()) {
			...
			System.out.println("SADF:"+System.currentTimeMillis());
	...
	private void setupTextures() {
		texIds[0] = this.loadPNGTexture("assets/images/ash_uvgrid01.png", GL13.GL_TEXTURE0);
		texIds[1] = this.loadPNGTexture("assets/images/ash_uvgrid02.png", GL13.GL_TEXTURE0);
	...
	private void logicCycle() {
		...
		modelAngle.z = (float)((System.currentTimeMillis() % 10000) / 300.0);
		//modelAngle.z = (float)(System.nanoTime() / 100000000.0);
		System.out.println("z:"+modelAngle.z);
		try {
			Thread.sleep(10);
	...
	private int loadShader(String filename, int type) {
		...
		System.out.println("Shared info log: " + glGetShaderInfoLog(shaderID, 10000));
