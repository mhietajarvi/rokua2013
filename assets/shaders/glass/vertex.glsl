...
uniform mat4 U_MODEL_TO_WORLD_M4[255];
...
void main() {
	...
	v_world_position = vec3(U_MODEL_TO_WORLD_M4[gl_InstanceID] * pos);
...
//	v_color_mult = U_COLOR_MULT_F[gl_InstanceID];
	...
	gl_Position = U_WORLD_TO_PROJECTED_M4 * U_MODEL_TO_WORLD_M4[gl_InstanceID] * pos;
	//gl_Position = pos;
}
